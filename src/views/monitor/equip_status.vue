    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-tag v-if="scope.row.onlinestatu === 0" size="small" type="danger">离线</el-tag>
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/Internetofthings/EquipmentState/showAllEquipment'),
          method: 'get',
      ...
      exportHandle(){
          var pash=""
          this.$http({
            url: this.$http.adornUrl('/Internetofthings/EquipmentState/exportEquipment'),
            method: 'post',
