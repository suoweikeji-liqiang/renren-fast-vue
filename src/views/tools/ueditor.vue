<template>
  ...
  <div class="mod-weather">
    ...
    <el-select v-model="value1" clearable placeholder="请选择省份">
      <el-option
    ...
    <el-select v-model="value2" clearable placeholder="请选择城市">
      <el-option
        v-for="item in options"
        :key="item.value2"
        :label="item.label"
    ...
    <el-select v-model="value3" clearable placeholder="请选择区域">
      <el-option
        v-for="item in options"
        :key="item.value3"
        :label="item.label"
    ...
    <el-select v-model="value5" clearable placeholder="请选择月份">
      <el-option
        v-for="item in options"
        :key="item.value5"
        :label="item.label"
